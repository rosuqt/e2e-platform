      ...
      >
        ...
        <DialogContent sx={{
          ...
          <Box sx={{ px: 3, pb: 3, pt: 3, display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 2 }}>
            <Button onClick={onClose} variant="outlined" sx={{ color: "#16a34a", borderColor: "#16a34a", fontWeight: 600, fontSize: 16, background: "#fff", borderRadius: 2, px: 4, '&:hover': { borderColor: "#166534", background: "#f1f5f9" } }}>Close</Button>
          </Box>
        </DialogContent>
      </Dialog>
    )
