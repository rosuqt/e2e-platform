...
export default function QuickApplyModal({
  ...
  return (
    <Dialog open={open} onClose={onClose} className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <Dialog.Panel className="bg-white shadow-xl max-w-5xl w-full flex flex-col sm:flex-row p-0 h-[530px] relative z-10">
        <button
          type="button"
          onClick={onClose}
        ...
        <div className="flex-1 pr-0 sm:pr-8 bg-white flex flex-col justify-center h-full">
          <div className="p-8">
            <Dialog.Title className="text-2xl font-bold mb-2">Let’s Get Your Quick Apply Ready</Dialog.Title>
