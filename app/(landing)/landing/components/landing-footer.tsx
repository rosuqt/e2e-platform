        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-600 mb-4">
              Connecting students to opportunities and helping employers find
              the perfect talent.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link
                  href="/legal#platform-guidelines"
                  className="text-gray-600 hover:text-blue-700"
                >
                  Platform Guidelines
                </Link>
            ...
            <div className="space-y-3">
              <div className="flex items-start">
                ...
                <span className="text-gray-600">
                  STI College Alabang, Metro Manila, Philippines
                </span>
              </div>
              <div className="flex items-start">
                <Mail className="w-5 h-5 text-blue-700 mr-2 mt-0.5" />
                <span className="text-gray-600">seekr.assist@gmail.com</span>
              </div>
              <div className="flex items-start">
