...
import { ChevronRight, Star, UserPlus, UserCheck, Users, Building2, GraduationCap } from "lucide-react"
      ...
      <section className="container mx-auto px-4 py-12 md:py-16">
        <div className="text-center max-w-3xl mx-auto mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            Connect, Follow, and Discover with <span className="text-blue-600">People</span>
          </h1>
          <p className="text-xl text-gray-600 mb-8">
            Build your professional network, follow employers, and discover new connections to enhance your internship
      ...
      <section className="container mx-auto px-4 py-12 md:py-16">
        <div className="bg-white rounded-xl shadow-lg border border-blue-100 overflow-hidden">
          <div className="p-6 md:p-8 border-b border-blue-100 bg-gradient-to-r from-blue-50 to-blue-100">
            <h2 className="text-2xl font-bold text-blue-700">What You Can Do</h2>
            <p className="text-gray-600">Explore the powerful features of the People module</p>
          </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="space-y-4">
                ...
                <p className="text-gray-600">
                  View and manage your classmates, friends, and network. Accept or ignore requests, favorite people, and
              ...
              <div className="space-y-4">
                ...
                <p className="text-gray-600">
                  Keep track of employers and companies you&apos;re interested in. Sort, favorite, and unfollow to manage
                  your professional interests.
                </p>
                <ul className="space-y-2">
                  <FeatureItem color="amber">Follow potential employers</FeatureItem>
                  <FeatureItem color="amber">Stay updated on company news</FeatureItem>
                  <FeatureItem color="amber">Discover job opportunities</FeatureItem>
                </ul>
                <Link href="/people/following" className="text-amber-600 font-medium flex items-center hover:underline">
              ...
              <div className="space-y-4">
                ...
                <p className="text-gray-600">
                  Find students, employers, and companies you may know or want to connect with. Explore and expand your
                  network.
                </p>
                <ul className="space-y-2">
                  <FeatureItem color="emerald">Find people you may know</FeatureItem>
                  <FeatureItem color="emerald">Discover relevant employers</FeatureItem>
                  <FeatureItem color="emerald">Explore companies in your field</FeatureItem>
                </ul>
                <Link
        ...
        <div className="container mx-auto px-4">
          <div className="text-center">
            <p className="text-gray-600 mb-4">
              &copy; 2025 <span className="font-semibold">InternConnect</span>
            </p>
...
function FeatureCard({
  ...
  return (
    <div className="p-6 md:p-8 flex flex-col h-full">
      ...
      <div className={`mt-auto rounded-xl bg-gradient-to-br ${colorClasses[color]} p-4 border`}>
        ...
        <Link href={link} className="flex items-center justify-center text-sm font-medium hover:underline">
...
function FeatureItem({
  children,
  color = "blue",
}: { children: React.ReactNode; color?: "blue" | "amber" | "emerald" }) {
  const colorClasses = {
    blue: "bg-blue-500",
    amber: "bg-amber-500",
