  ...
  return (
    <div className="pt-20 flex justify-center items-center min-h-screen bg-gradient-to-br from-blue-50 to-sky-100 relative overflow-y-auto pb-10">
      ...
      >
        ...
        >
          <span className="bg-gradient-to-r from-blue-500 to-sky-400 text-transparent bg-clip-text">Forgot Password</span>
        </motion.h2>
        ...
        {submitted ? (
          ...
          >
            If an account exists for <span className="font-semibold">{email}</span>, you will receive a password reset email shortly.
          </motion.div>
        ) : (
          <motion.form
        ...
        >
          ...
          <Link href="/sign-in" className="text-blue-500 hover:text-blue-700 transition-colors">
            Sign In
          </Link>
        </motion.p>
        ...
        >
          Need help? Contact{" "}
          <a href="mailto:support@testcompany.com" className="text-blue-500 hover:text-blue-700 transition-colors">
