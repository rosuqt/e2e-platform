                ...
                <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0 bg-gradient-to-r from-blue-500 to-blue-600 text-white">
                  <div>
                    ...
                    <CardDescription className="text-blue-100">
                      You have {analyticsData.newToday} new applicants today
                    </CardDescription>
                  </div>
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-center justify-between">
                                ...
                                <Badge
                                  variant="standard"
                                  className={`
                                    ${applicant.status === "new" ? "bg-blue-500 hover:bg-blue-600 text-white" : ""}
                                    ${applicant.status === "reviewed" ? "bg-yellow-500 hover:bg-yellow-600 text-white" : ""}
                                    ${applicant.status === "interview" ? "bg-purple-500 hover:bg-purple-600 text-white" : ""}
                                    ${applicant.status === "offer" ? "bg-green-500 hover:bg-green-600 text-white" : ""}
                                  `}
                                >
