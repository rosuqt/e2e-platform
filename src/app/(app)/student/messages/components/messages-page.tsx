    ...
    <div className="flex flex-col h-screen w-full border-x bg-[#f0f5fb] overflow-hidden">
      <div className="flex h-full">
        ...
        <div className="w-80 border-r flex flex-col bg-white">
          ...
          <div className="overflow-y-auto flex-1 h-[calc(100%-100px)]" style={{ maxHeight: "calc(100% - 100px)" }}>
        ...
        <div className="flex-1 flex flex-col overflow-y-auto">
          {activeConvo && (
            <>
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-4 h-[calc(100%-150px)]" style={{ maxHeight: "calc(100% - 150px)" }}>
