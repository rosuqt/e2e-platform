    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-32">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              <span className="text-yellow-500">Verified</span> <span className="text-blue-700">Companies</span>
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Explore opportunities with our partnered companies. Connect with top employers offering OJT programs and
              career growth opportunities.
            </p>
          </motion.div>

          <div className="overflow-hidden">
            <div className="scrolling-wrapper flex gap-6 py-4">
