...
const companies = [
  {
    ...
    description:
      "Smart interview preparation tool that analyzes speech patterns and hesitation points.",
    rating: 5,
  },
  {
    name: "Vivision",
    description:
      "Coaching software that enhances communication skills and interview readiness.",
    rating: 5,
  },
  {
    name: "vvInsecure",
    description:
      "Adaptive interview training system that sharpens answers and reduces hesitation.",
    rating: 5,
  },
  {
    name: "Kemly n Friends",
    description:
      "Smart analytics-based coaching that improves your interview performance.",
    rating: 5,
  },
  {
    name: "Parker State",
    description:
      "Realistic AI-driven mock interviews with instant feedback to improve performance.",
    rating: 5,
  },
  {
    name: "Vivi Enterfries",
    description:
      "Personalized career coaching with AI-backed performance insights.",
    rating: 5,
  },
  {
    name: "Vox Tech",
    description:
      "VoxTech dominates the airwaves with state-of-the-art digital networks. ",
    rating: 5,
  },
];
              ...
              <div className="mt-10 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 justify-items-center px-5">
                ...
                <div className="bg-[#1C2B5E] text-white p-6 rounded-lg shadow-lg w-full max-w-[375px] flex flex-col items-start transform transition-transform duration-300 ease-in-out hover:scale-110">
                  ...
                  <p className="mt-2 text-gray-300 text-sm">
                    Upload or build your resume to highlight your experience and
                    skills. Make it easier for employers to discover and connect
                    with you.
                  </p>
                </div>
                ...
                <div className="bg-[#1C2B5E] text-white p-6 rounded-lg shadow-lg w-full max-w-[375px] flex flex-col items-start transform transition-transform duration-300 ease-in-out hover:scale-110">
                  ...
                  <p className="mt-2 text-gray-300 text-sm">
                    Highlight your milestones and successes, showcasing your
                    skills, growth, and dedication. From personal victories to
                ...
                <div className="bg-[#1C2B5E] text-white p-6 rounded-lg shadow-lg w-full max-w-[375px] flex flex-col items-start transform transition-transform duration-300 ease-in-out hover:scale-110">
                  ...
                  <p className="mt-2 text-gray-300 text-sm">
                    Showcase your skills and expertise to stand out. Let
                    employers see what you bring to the table.
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="mt-36 pt-9 pb-10 flex flex-col lg:flex-row justify-between items-center">
                <div className="mr-6 text-left flex flex-col items-start max-w-[900px] space-y-4">
                  ...
                  <h1 className="text-darkBlue text-5xl font-bold md:ml-8 px-5">
                    Candidate Matches
                  </h1>
                  <p className="mt-4 text-gray-500 text-lg md:ml-8 pt-4 px-5 w-[600px]">
                    Create clear, engaging job postings with AI assistance.
                    Optimize your listings to attract the right candidates
                    effortlessly.
                  </p>
                  <Link href="/sign-in">
                    <motion.button
                ...
                <div className="bg-gray-300 w-[400px] h-[520px] rounded-[30px] mr-[95px] relative">
                  <img
                    src="images/abstract-swirls.jpg"
                    alt="Abstract Swirls"
            ...
            >
              <div className="mt-36 pt-9 pb-10 flex flex-col lg:flex-row justify-between items-center">
                ...
                <div className="mr-6 text-left flex flex-col items-start max-w-[900px] space-y-4">
                  ...
                  <h1 className="text-darkBlue text-5xl font-bold md:ml-48 px-5">
                    who can help
                  </h1>
                  <p className="mt-4 text-gray-500 text-lg md:ml-48 pt-4 px-5 w-[600px]">
                    Build meaningful connections with people who can support
                    your career journey. Use the in-app messaging system to
                    network, ask questions, and explore new opportunities.
                  </p>
              ...
              <div className="bg-darkBlue flex flex-col lg:flex-row items-center rounded-[80px] justify-center ml-16 mt-44 gap-64 w-[1300px] h-[100px] md:h-[500px] lg:h-[500px]">
                ...
                <div className="max-w-md text-left">
                  ...
                  <p className="mt-2 text-xl text-gray-400">
                    Prepare for real job interviews with AI-generated questions
                    and feedback.
                  </p>
                </div>
              ...
              <div className=" py-56 mb-[-250px]">
                <div className="max-w-md text-left">
                  ...
                  <p className="mt-2 text-lg text-gray-600 ml-24 w-[600px]">
                    Explore opportunities with our partnered companies. Connect
                    with top employers offering OJT programs and career growth
                    opportunities
                  </p>
                </div>
              </div>
