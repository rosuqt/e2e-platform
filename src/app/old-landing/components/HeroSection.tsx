...
export default function HomePage() {
  ...
  const jobOptions: { [key: string]: string[] } = {
    ...
    BSHM: [
      ...
      "Bartender",
      "Resort Entertainment Coordinator",
      "Event Catering Manager",
      "Housekeeping Supervisor",
      "Hospitality Recruitment Specialist",
      "Hotel Front Desk Manager",
      "Airbnb Property Manager",
      "Cruise Ship Food & Beverage Manager",
      "Private Chef",
      "Culinary Instructor",
      "Sustainable Hospitality Consultant",
      ...
      <div className="relative bg-[#1551A9] min-h-[85vh] flex flex-wrap items-center justify-center px-6 py-16 lg:px-10 lg:flex-row">
        <div className="w-full lg:w-1/2 text-center lg:text-left">
          ...
          <p className="mt-4 text-lg font-light text-gray-200 max-w-xl mx-auto lg:mx-0">
            Build your professional network, showcase your skills, and discover
            exciting internship opportunities—all in one place. Start your
          ...
          <div className="mt-6 flex flex-wrap justify-center lg:justify-start gap-4 z-[9999] relative">
            ...
            <Dropdown
              ...
              placeholder={
                selectedCourse
                  ? `e.g ${jobOptions[selectedCourse]?.[0]}`
        ...
        <div className="lg:w-1/2 flex justify-center mt-10 lg:mt-0">
          <div className="w-[500px] h-[500px] bg-gray-300 rounded-full overflow-hidden mr-[-90px]">
            <img
              src="https://www.sti.edu/uploads/Scope_Landscape_2024.webp"
              alt="Hero"
