...
/*
issues: toast alert shows up twice idk why
        ...
        >
          <div className="space-y-6 w-full">
            ...
            <div className="px-6 mt-4">
              <h3 className="text-md font-semibold text-gray-700">Short Description</h3>
              <p className="text-sm text-gray-500">Ensure all the information provided is accurate before submission.</p>
            </div>
            <div className="bg-gray-50 p-6 rounded-lg shadow-md w-full">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
                ...
                <div>
                  ...
                  <p>{formData.companyBranch || "N/A"}</p>
                </div>
                <div>
                  <p className="font-semibold">Industry:</p>
                  <p>{formData.companyIndustry || "N/A"}</p>
                </div>
                <div>
                  <p className="font-semibold">Company Size:</p>
                  <p>{formData.companySize || "N/A"}</p>
                </div>
                <div>
                  <p className="font-semibold">Email Domain:</p>
                  <p>{formData.companyEmailDomain || "N/A"}</p>
                </div>
                <div>
                  <p className="font-semibold">Website:</p>
                  <p>{formData.companyWebsite || "N/A"}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg shadow-md w-full">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
                <div>
                  ...
                  <p>{formData.address.country || "N/A"}</p>
                </div>
                <div>
                  <p className="font-semibold">City:</p>
                  <p>{formData.address.city || "N/A"}</p>
                </div>
                <div>
                  <p className="font-semibold">Street:</p>
                  <p>{formData.address.street || "N/A"}</p>
                </div>
                <div>
                  <p className="font-semibold">Province:</p>
                  <p>{formData.address.province || "N/A"}</p>
                </div>
                <div>
                  <p className="font-semibold">Contact Email:</p>
                  <p>{formData.address.contactEmail || "N/A"}</p>
                </div>
                <div>
                  <p className="font-semibold">Contact Number:</p>
                  <p>{formData.address.contactNumber || "N/A"}</p>
                </div>
                <div className="col-span-1 md:col-span-2">
                  <p className="font-semibold">Exact Address:</p>
                  <p>{formData.address.exactAddress || "N/A"}</p>
                </div>
              </div>
            </div>
          </div>
