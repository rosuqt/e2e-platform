...
export default function SignUpForm() {
  ...
  return (
    <Card className="mt-10 pt-6 w-full max-w-3xl shadow-xl border-2 border-blue-200 bg-white relative overflow-hidden">
      <CardHeader className="relative z-10">
        <motion.h1
          className="text-2xl font-bold text-center bg-gradient-to-r from-blue-500 to-sky-400 text-transparent bg-clip-text mt-2"
